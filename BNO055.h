...
int  BNO055_begin               (bno055_opmode_t mode); // DEFAULT: OPERATION_MODE_NDOF
...
void BNO055_displayRevInfo      (void);
void BNO055_setExtCrystalUse    (int usextal);
void BNO055_getSystemStatus     (uint8_t *system_status,
                                                        uint8_t *self_test_result,
                                                        uint8_t *system_error);
void BNO055_displaySystemStatus (void);
void BNO055_getCalibration      (uint8_t* system, uint8_t* gyro, uint8_t* accel, uint8_t* mag);
